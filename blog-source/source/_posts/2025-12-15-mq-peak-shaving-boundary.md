---
title: MQ 为什么能削峰，但不能解决所有问题
date: 2025-12-06 19:33:00
...
source_path: 数据库与中间件/2025-12-15-mq-peak-shaving-boundary.md
---
...
消息队列把同步压力转成异步处理，但增加最终一致性复杂度。

很多问题不是不会用，而是用得太顺手了，顺手到把边界条件给省掉了。

## 这类问题一般怎么出现

我脑子里会先放这个场景：把下单后的积分发放改成异步消息。
