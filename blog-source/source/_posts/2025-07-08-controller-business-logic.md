---
title: Controller 层到底该写多少逻辑
date: 2025-07-07 21:44:00
...
source_path: 后端框架/2025-07-08-controller-business-logic.md
---
...
Controller 只做参数接收、校验触发和响应转换。

很多问题不是不会用，而是用得太顺手了，顺手到把边界条件给省掉了。

## 这类问题一般怎么出现

我脑子里会先放这个场景：把一个臃肿 Controller 方法拆回 service。
