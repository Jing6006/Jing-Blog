...
source_path: Java 基础/2025-06-13-thread-pool-rejection.md
---
...
- AbortPolicy 适合快速暴露问题。
  我现在的理解：先记结论，再回到代码里找一个能验证它的场景。
- CallerRunsPolicy 会拖慢调用方。
  我现在的理解：先记结论，再回到代码里找一个能验证它的场景。
- 业务任务要能重试或排队。
  我现在的理解：先记结论，再回到代码里找一个能验证它的场景。
...
我会直接拿这个场景来讲：模拟线程池打满后接口如何返回友好提示。
