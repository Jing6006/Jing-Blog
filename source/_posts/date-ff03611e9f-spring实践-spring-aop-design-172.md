...
categories:
  - Spring实践
description: 围绕 AOP 日志切面 的取舍，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=1200&q=80
abbrlink: spring-aop-design-172
synced_from_date: true
source_path: Spring实践/spring-aop-design-172.md
---

这篇记录 AOP 日志切面 的取舍。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
