---
title: ThreadLocal 清理踩坑记录
date: 2026-01-15 17:38:00
updated: 2026-01-15 09:38:00
tags:
  - Java
  - ThreadLocal
  - 排障
categories:
  - 并发编程
description: 围绕 ThreadLocal 清理 的记录，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1504639725590-34d0984388bd?auto=format&fit=crop&w=1200&q=80
abbrlink: threadlocal-pitfall-128
synced_from_date: true
source_path: 并发编程/threadlocal-pitfall-128.md
---

这篇记录 ThreadLocal 清理 的记录。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
