---
title: Spring 事件日常检查清单
date: 2025-10-24 14:00:00
updated: 2025-10-24 06:00:00
tags:
  - Spring
  - 事件驱动
  - 异步
categories:
  - Spring实践
description: 围绕 Spring 事件 的清单，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1544383835-bda2bc66a55d?auto=format&fit=crop&w=1200&q=80
abbrlink: spring-event-checklist-095
synced_from_date: true
source_path: Spring实践/spring-event-checklist-095.md
---

这篇记录 Spring 事件 的清单。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
