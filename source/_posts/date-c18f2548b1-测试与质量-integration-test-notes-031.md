---
title: 集成测试学习笔记
date: 2025-05-17 10:12:00
updated: 2025-05-17 02:12:00
tags:
  - Spring Boot
  - 测试
  - 质量保障
categories:
  - 测试与质量
description: 围绕 集成测试 的笔记，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=1200&q=80
abbrlink: integration-test-notes-031
synced_from_date: true
source_path: 测试与质量/integration-test-notes-031.md
---

这篇记录 集成测试 的笔记。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
