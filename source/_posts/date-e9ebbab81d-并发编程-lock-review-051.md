---
title: 锁粒度控制实践复盘
date: 2025-07-06 10:12:00
updated: 2025-07-06 02:12:00
tags:
  - Java
  - 并发控制
  - 锁
categories:
  - 并发编程
description: 围绕 锁粒度控制 的复盘，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=1200&q=80
abbrlink: lock-review-051
synced_from_date: true
source_path: 并发编程/lock-review-051.md
---

这篇记录 锁粒度控制 的复盘。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
