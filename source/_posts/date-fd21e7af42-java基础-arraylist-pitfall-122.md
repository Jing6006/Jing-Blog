---
title: ArrayList 容量规划踩坑记录
date: 2025-12-31 11:25:00
updated: 2025-12-31 03:25:00
tags:
  - Java
  - 集合
  - 性能
categories:
  - Java基础
description: 围绕 ArrayList 容量规划 的记录，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=1200&q=80
abbrlink: arraylist-pitfall-122
synced_from_date: true
source_path: Java基础/arraylist-pitfall-122.md
---

这篇记录 ArrayList 容量规划 的记录。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
