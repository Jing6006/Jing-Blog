---
title: 限流降级学习笔记
date: 2025-05-10 17:38:00
updated: 2025-05-10 09:38:00
tags:
  - 架构
  - 限流
  - 稳定性
categories:
  - 架构设计
description: 围绕 限流降级 的笔记，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1504639725590-34d0984388bd?auto=format&fit=crop&w=1200&q=80
abbrlink: rate-limit-notes-028
synced_from_date: true
source_path: 架构设计/rate-limit-notes-028.md
---

这篇记录 限流降级 的笔记。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
