---
title: 锁粒度控制踩坑记录
date: 2026-01-17 18:50:00
updated: 2026-01-17 10:50:00
tags:
  - Java
  - 并发控制
  - 锁
categories:
  - 并发编程
description: 围绕 锁粒度控制 的记录，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=80
abbrlink: lock-pitfall-129
synced_from_date: true
source_path: 并发编程/lock-pitfall-129.md
---

这篇记录 锁粒度控制 的记录。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
