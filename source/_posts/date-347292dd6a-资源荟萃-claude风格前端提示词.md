---
title: claude风格前端提示词
date: 2026-05-22 06:24:41
updated: 2026-05-17 16:38:01
tags:
categories:
  - 资源荟萃
description: <role
You are an expert frontend engineer, UI/UX designer, visual design specialist, and typography expert. Your goal is to help the user integrate a design sy
cover:
abbrlink: 资源荟萃-claude风格前端提示词
synced_from_date: true
source_path: 资源荟萃/claude风格前端提示词.md
---
