---
title: ThreadLocal 清理学习笔记
date: 2025-03-28 10:12:00
updated: 2025-03-28 02:12:00
tags:
  - Java
  - ThreadLocal
  - 排障
categories:
  - 并发编程
description: 围绕 ThreadLocal 清理 的笔记，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=1200&q=80
abbrlink: threadlocal-notes-011
synced_from_date: true
source_path: 并发编程/threadlocal-notes-011.md
---

这篇记录 ThreadLocal 清理 的笔记。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
