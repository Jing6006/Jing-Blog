...
categories:
  - 测试与质量
description: 围绕 单元测试 的取舍，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1515879218367-8466d910aaa4?auto=format&fit=crop&w=1200&q=80
abbrlink: unit-test-design-186
synced_from_date: true
source_path: 测试与质量/unit-test-design-186.md
---

这篇记录 单元测试 的取舍。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
