---
title: Linux 日志排查踩坑记录
date: 2026-03-18 12:38:00
updated: 2026-03-18 04:38:00
tags:
  - Linux
  - 日志
  - 排障
categories:
  - Linux部署
description: 围绕 Linux 日志排查 的记录，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=1200&q=80
abbrlink: linux-log-pitfall-153
synced_from_date: true
source_path: Linux部署/linux-log-pitfall-153.md
---

这篇记录 Linux 日志排查 的记录。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
