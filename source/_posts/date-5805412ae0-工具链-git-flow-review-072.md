---
title: Git 分支协作实践复盘
date: 2025-08-28 11:25:00
updated: 2025-08-28 03:25:00
tags:
  - Git
  - 工程实践
  - 协作
categories:
  - 工具链
description: 围绕 Git 分支协作 的复盘，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=1200&q=80
abbrlink: git-flow-review-072
synced_from_date: true
source_path: 工具链/git-flow-review-072.md
---

这篇记录 Git 分支协作 的复盘。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
