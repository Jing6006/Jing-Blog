---
title: Nginx 反向代理学习笔记
date: 2025-05-27 14:00:00
updated: 2025-05-27 06:00:00
tags:
  - Nginx
  - 部署
  - 运维
categories:
  - Linux部署
description: 围绕 Nginx 反向代理 的笔记，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1544383835-bda2bc66a55d?auto=format&fit=crop&w=1200&q=80
abbrlink: nginx-notes-035
synced_from_date: true
source_path: Linux部署/nginx-notes-035.md
---

这篇记录 Nginx 反向代理 的笔记。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
