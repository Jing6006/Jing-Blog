---
title: ArrayList 容量规划实践复盘
date: 2025-06-19 13:50:00
updated: 2025-06-19 05:50:00
tags:
  - Java
  - 集合
  - 性能
categories:
  - Java基础
description: 围绕 ArrayList 容量规划 的复盘，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=1200&q=80
abbrlink: arraylist-review-044
synced_from_date: true
source_path: Java基础/arraylist-review-044.md
---

这篇记录 ArrayList 容量规划 的复盘。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
