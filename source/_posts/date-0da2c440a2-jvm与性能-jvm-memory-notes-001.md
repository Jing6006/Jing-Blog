---
title: JVM 内存模型学习笔记
date: 2025-03-03 10:12:00
updated: 2025-03-03 02:12:00
tags:
  - Java
  - JVM
  - 性能
categories:
  - JVM与性能
description: 围绕 JVM 内存模型 的笔记，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=1200&q=80
abbrlink: jvm-memory-notes-001
synced_from_date: true
source_path: JVM与性能/jvm-memory-notes-001.md
---

这篇记录 JVM 内存模型 的笔记。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
