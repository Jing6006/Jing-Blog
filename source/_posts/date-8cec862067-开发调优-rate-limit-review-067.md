...
categories:
  - 开发调优
description: 围绕 限流降级 的复盘，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=1200&q=80
abbrlink: rate-limit-review-067
synced_from_date: true
source_path: 开发调优/rate-limit-review-067.md
---

这篇记录 限流降级 的复盘。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
