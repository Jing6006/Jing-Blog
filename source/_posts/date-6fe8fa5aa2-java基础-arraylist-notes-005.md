---
title: ArrayList 容量规划学习笔记
date: 2025-03-13 14:00:00
updated: 2025-03-13 06:00:00
tags:
  - Java
  - 集合
  - 性能
categories:
  - Java基础
description: 围绕 ArrayList 容量规划 的笔记，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1544383835-bda2bc66a55d?auto=format&fit=crop&w=1200&q=80
abbrlink: arraylist-notes-005
synced_from_date: true
source_path: Java基础/arraylist-notes-005.md
---

这篇记录 ArrayList 容量规划 的笔记。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
