...
categories:
  - 开发调优
description: 围绕 限流降级 的记录，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1544383835-bda2bc66a55d?auto=format&fit=crop&w=1200&q=80
abbrlink: rate-limit-pitfall-145
synced_from_date: true
source_path: 开发调优/rate-limit-pitfall-145.md
---

这篇记录 限流降级 的记录。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
