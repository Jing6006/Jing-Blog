---
title: AOP 日志切面日常检查清单
date: 2025-10-22 13:50:00
updated: 2025-10-22 05:50:00
tags:
  - Spring
  - AOP
  - 日志
categories:
  - Spring实践
description: 围绕 AOP 日志切面 的清单，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=1200&q=80
abbrlink: spring-aop-checklist-094
synced_from_date: true
source_path: Spring实践/spring-aop-checklist-094.md
---

这篇记录 AOP 日志切面 的清单。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
