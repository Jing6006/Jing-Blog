...
categories:
  - 架构设计
description: 围绕 消息重试 的复盘，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1544383835-bda2bc66a55d?auto=format&fit=crop&w=1200&q=80
abbrlink: message-retry-review-065
synced_from_date: true
source_path: 架构设计/message-retry-review-065.md
---

这篇记录 消息重试 的复盘。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
