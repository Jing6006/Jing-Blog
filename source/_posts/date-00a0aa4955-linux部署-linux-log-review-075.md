---
title: Linux 日志排查实践复盘
date: 2025-09-04 14:00:00
updated: 2025-09-04 06:00:00
tags:
  - Linux
  - 日志
  - 排障
categories:
  - Linux部署
description: 围绕 Linux 日志排查 的复盘，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1544383835-bda2bc66a55d?auto=format&fit=crop&w=1200&q=80
abbrlink: linux-log-review-075
synced_from_date: true
source_path: Linux部署/linux-log-review-075.md
---

这篇记录 Linux 日志排查 的复盘。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
