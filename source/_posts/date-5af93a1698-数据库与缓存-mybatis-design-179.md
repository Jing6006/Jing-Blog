---
title: MyBatis 映射设计取舍
date: 2026-05-22 18:50:00
updated: 2026-05-22 10:50:00
tags:
  - MyBatis
  - Java
  - 数据库
categories:
  - 数据库与缓存
description: 围绕 MyBatis 映射 的取舍，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=80
abbrlink: mybatis-design-179
synced_from_date: true
source_path: 数据库与缓存/mybatis-design-179.md
---

这篇记录 MyBatis 映射 的取舍。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
