---
title: MyBatis 映射踩坑记录
date: 2026-02-14 09:00:00
updated: 2026-02-14 01:00:00
tags:
  - MyBatis
  - Java
  - 数据库
categories:
  - 数据库与缓存
description: 围绕 MyBatis 映射 的记录，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1515879218367-8466d910aaa4?auto=format&fit=crop&w=1200&q=80
abbrlink: mybatis-pitfall-140
synced_from_date: true
source_path: 数据库与缓存/mybatis-pitfall-140.md
---

这篇记录 MyBatis 映射 的记录。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
