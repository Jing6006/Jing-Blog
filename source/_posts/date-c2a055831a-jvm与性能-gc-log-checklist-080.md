...
categories:
  - JVM与性能
description: 围绕 GC 日志 的清单，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1515879218367-8466d910aaa4?auto=format&fit=crop&w=1200&q=80
abbrlink: gc-log-checklist-080
synced_from_date: true
source_path: JVM与性能/gc-log-checklist-080.md
---

这篇记录 GC 日志 的清单。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
