---
title: AOP 日志切面踩坑记录
date: 2026-01-27 12:38:00
updated: 2026-01-27 04:38:00
tags:
  - Spring
  - AOP
  - 日志
categories:
  - Spring实践
description: 围绕 AOP 日志切面 的记录，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=1200&q=80
abbrlink: spring-aop-pitfall-133
synced_from_date: true
source_path: Spring实践/spring-aop-pitfall-133.md
---

这篇记录 AOP 日志切面 的记录。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
