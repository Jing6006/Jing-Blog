---
title: GC 日志设计取舍
date: 2026-03-31 17:38:00
updated: 2026-03-31 09:38:00
tags:
  - JVM
  - GC
  - 排障
categories:
  - JVM与性能
description: 围绕 GC 日志 的取舍，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1504639725590-34d0984388bd?auto=format&fit=crop&w=1200&q=80
abbrlink: gc-log-design-158
synced_from_date: true
source_path: JVM与性能/gc-log-design-158.md
---

这篇记录 GC 日志 的取舍。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
