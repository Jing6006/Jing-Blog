---
title: 集成测试踩坑记录
date: 2026-03-06 17:38:00
updated: 2026-03-06 09:38:00
tags:
  - Spring Boot
  - 测试
  - 质量保障
categories:
  - 测试与质量
description: 围绕 集成测试 的记录，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1504639725590-34d0984388bd?auto=format&fit=crop&w=1200&q=80
abbrlink: integration-test-pitfall-148
synced_from_date: true
source_path: 测试与质量/integration-test-pitfall-148.md
---

这篇记录 集成测试 的记录。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
