---
title: Linux 日志排查学习笔记
date: 2025-05-30 15:12:00
updated: 2025-05-30 07:12:00
tags:
  - Linux
  - 日志
  - 排障
categories:
  - Linux部署
description: 围绕 Linux 日志排查 的笔记，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=1200&q=80
abbrlink: linux-log-notes-036
synced_from_date: true
source_path: Linux部署/linux-log-notes-036.md
---

这篇记录 Linux 日志排查 的笔记。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
