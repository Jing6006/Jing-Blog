---
title: Git 分支协作学习笔记
date: 2025-05-22 12:38:00
updated: 2025-05-22 04:38:00
tags:
  - Git
  - 工程实践
  - 协作
categories:
  - 工具链
description: 围绕 Git 分支协作 的笔记，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=1200&q=80
abbrlink: git-flow-notes-033
synced_from_date: true
source_path: 工具链/git-flow-notes-033.md
---

这篇记录 Git 分支协作 的笔记。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
