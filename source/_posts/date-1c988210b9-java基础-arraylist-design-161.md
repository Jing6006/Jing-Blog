---
title: ArrayList 容量规划设计取舍
date: 2026-04-07 10:12:00
updated: 2026-04-07 02:12:00
tags:
  - Java
  - 集合
  - 性能
categories:
  - Java基础
description: 围绕 ArrayList 容量规划 的取舍，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=1200&q=80
abbrlink: arraylist-design-161
synced_from_date: true
source_path: Java基础/arraylist-design-161.md
---

这篇记录 ArrayList 容量规划 的取舍。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
