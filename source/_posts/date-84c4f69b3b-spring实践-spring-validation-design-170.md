...
categories:
  - Spring实践
description: 围绕 参数校验 的取舍，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1515879218367-8466d910aaa4?auto=format&fit=crop&w=1200&q=80
abbrlink: spring-validation-design-170
synced_from_date: true
source_path: Spring实践/spring-validation-design-170.md
---

这篇记录 参数校验 的取舍。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
