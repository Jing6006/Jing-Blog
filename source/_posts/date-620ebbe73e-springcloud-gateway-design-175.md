...
categories:
  - SpringCloud
description: 围绕 网关路由配置 的取舍，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1544383835-bda2bc66a55d?auto=format&fit=crop&w=1200&q=80
abbrlink: gateway-design-175
synced_from_date: true
source_path: SpringCloud/gateway-design-175.md
---

这篇记录 网关路由配置 的取舍。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
