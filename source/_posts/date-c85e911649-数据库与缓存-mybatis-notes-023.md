---
title: MyBatis 映射学习笔记
date: 2025-04-27 12:38:00
updated: 2025-04-27 04:38:00
tags:
  - MyBatis
  - Java
  - 数据库
categories:
  - 数据库与缓存
description: 围绕 MyBatis 映射 的笔记，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=1200&q=80
abbrlink: mybatis-notes-023
synced_from_date: true
source_path: 数据库与缓存/mybatis-notes-023.md
---

这篇记录 MyBatis 映射 的笔记。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
