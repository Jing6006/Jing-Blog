---
title: GC 日志踩坑记录
date: 2025-12-23 18:50:00
updated: 2025-12-23 10:50:00
tags:
  - JVM
  - GC
  - 排障
categories:
  - JVM与性能
description: 围绕 GC 日志 的记录，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=80
abbrlink: gc-log-pitfall-119
synced_from_date: true
source_path: JVM与性能/gc-log-pitfall-119.md
---

这篇记录 GC 日志 的记录。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
