---
title: ThreadLocal 清理设计取舍
date: 2026-04-22 16:25:00
updated: 2026-04-22 08:25:00
tags:
  - Java
  - ThreadLocal
  - 排障
categories:
  - 并发编程
description: 围绕 ThreadLocal 清理 的取舍，记录 Java 后端项目里的判断步骤和实践取舍。
cover: https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=1200&q=80
abbrlink: threadlocal-design-167
synced_from_date: true
source_path: 并发编程/threadlocal-design-167.md
---

这篇记录 ThreadLocal 清理 的取舍。写它不是为了把概念背得更熟，而是把一次项目里可能遇到的问题拆成可复用的判断步骤。
